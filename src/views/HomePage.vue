<template>
  <div class="container">
    <NavBar />
    <div class="home">
      <img class="myImg" src="../assets/myProfilePic.jpeg" alt="logo" />
      <i>HELLO! <br />Welcome to my world</i>
      ...
      <a
        ...
        >Github Link</a
      >
      <router-link active-class="active" to="./NotFound.vue">Error page</router-link>
    </div>
  </div>
</template>
